...
const buttonAdapt = document.getElementById('adapt');
const buttonMobileTemplates = document.getElementById('mobileTemplates');
const buttonDesktopTemplates = document.getElementById('desktopTemplates');
const buttonEditable = document.getElementById('editable');
